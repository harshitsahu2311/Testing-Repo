...
function CustomerDatatable({ onSelectionChange }: CustomerDataTableProps) {
  ...
  useEffect(() => {
    console.log("CustomerDatatable rendered with page:", page, "size:", size);
    ...
    },
    {
      ...
      renderCell: (params: GridCellParams) => (
        <Button
          ...
          size="small"
          onClick={() =>
            navigate(`/customer-details/${params.row.id}`, {
