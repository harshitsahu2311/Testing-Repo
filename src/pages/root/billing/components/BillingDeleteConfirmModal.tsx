...
export type BillingDeleteConfirmModalProps = Omit<
  FloModalProps,
  "sx" | "children" | "onClose"
> & {
  handleClose: () => void;
...
function BillingDeleteConfirmModal(props: BillingDeleteConfirmModalProps) {
...
export default BillingDeleteConfirmModal;
